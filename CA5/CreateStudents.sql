...
INSERT INTO `StudentGrades` (`id`, `student_id`, `first_name`, `last_name`, `course_id`, `course_name`, `grade`, `semester`)
VALUES (1, 100, 'Andrew', 'Smalls', 301, 'Computer Science', 40.5, 'Semester 1'),
